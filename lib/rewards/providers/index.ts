...
// registered provider, same as "weekly"/"quest"/"game"/"ai"/"premium"/
// "airdrop" already did — reward-service.ts's existing fallback renders
// them as isActive: false ("Coming soon") rather than a fabricated
// number. Only "staking" (real, read-only) remains registered.
//
...
export const REWARD_PROVIDERS: RewardProvider[] = [stakingRewardsProvider];
