...
const { x402DiscoverResourceTool, x402PreparePaymentTool } = await import(
...
/**
 * Production tool POSTs /api/x402/discover, which returns HTTP 200 with:
 *   { status: 402, body: { x402Version, accepts, ... }, finalUrl }
 */
