...
export function BottomNav() {
  ...
  return (
    <nav
      aria-label="Primary"
      className="fixed inset-x-0 bottom-0 z-50 border-t border-white/[0.08] bg-background/95 backdrop-blur-md sm:hidden"
            ...
            >
              {active && (
                <motion.span
                  ...
                  className="absolute inset-x-8 top-0 h-0.5 rounded-full bg-primary"
              ...
              <span className={clsx("text-[10px]", active && "font-medium text-white")}>
                {tab.label}
              </span>
            </Link>
          );
